...
**Auto-Configured Debugging** — Enable `security.enable_debugging: true` and the VM automatically detects your project language and exposes the correct debugger ports (Node.js 9229, Python 5678, Go 2345, etc.).
