...
pub const SERVICE_DEFINITIONS: &str = include_str!("docker/shared/service_definitions.yml");
pub const ZSHRC_TEMPLATE: &str = include_str!("docker/shared/zshrc.j2");
pub const THEMES_JSON: &str = include_str!("docker/shared/themes.json");
pub const CLAUDE_SETTINGS: &str = include_str!("docker/shared/claude-settings.json");
pub const GEMINI_SETTINGS: &str = include_str!("docker/shared/gemini-settings.json");
