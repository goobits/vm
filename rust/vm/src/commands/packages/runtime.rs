...
mod tests {
    use super::{
        apply_environment, configured_git_identity, create_directory, guest_checkout_root,
        infer_checkout_id, path_exists, path_is_file, read_file, remove_directory, remove_file,
