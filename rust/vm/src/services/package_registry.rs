...
/// Package Registry service that implements the ManagedService trait
...
impl PackageRegistryService {
    /// Create a new PackageRegistryService instance
...
impl ManagedService for PackageRegistryService {
    ...
    async fn stop(&self) -> Result<()> {
        tracing::debug!("Package registry stop requested");
